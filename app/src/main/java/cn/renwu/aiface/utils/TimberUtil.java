...
import cn.renwu.aiface.BuildConfig;
import timber.log.Timber;

/**
 * Timber打印开关工具类
 * 注意：1、需要依赖Timber，如：compile 'com.jakewharton.timber:timber:4.7.1'
        2、gradle中设置如下：
            android {
                buildTypes {
                    ...
...
public class TimberUtil {
    ...
    public static void setLogAuto(){
        if (BuildConfig.LOG_DEBUG) {//debug版本
            Timber.plant(new Timber.DebugTree());
        } else {//release版本
